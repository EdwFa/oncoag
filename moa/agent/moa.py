...
load_dotenv()
# print('Start MOAgent getenv - ', os.getenv('GROQ_API_KEY'))
# print('os-environ',os.environ.get('GROQ_API_KEY'))
...
# print('loaded dotenv - ', os.getenv('GROQ_API_KEY'))
...
class MOAgent:
    def __init__(
        ...
        # print('MOAgent dotenv - ', os.getenv('GROQ_API_KEY'))
    ...
    def _configure_layer_agent(
        ...
        if not layer_agent_config:
            layer_agent_config = {
                ...
                'layer_agent_2' : {'system_prompt': SYSTEM_PROMPT, 'model_name': 'deepseek-r1-distill-llama-70b'},
                'layer_agent_3' : {'system_prompt': SYSTEM_PROMPT, 'model_name': 'qwen-qwq-32b'},
                'layer_agent_4': {'system_prompt': SYSTEM_PROMPT, 'model_name': 'gemma2-9b-it'}
            }
        ...
        for key, value in layer_agent_config.items():
            chain = MOAgent._create_agent_from_system_prompt(
                ...
                model_name=value.pop("model_name", 'qwen-qwq-32b'),
                **value
            )
