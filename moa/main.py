...
layer_agent_config = {
    ...
    'layer_agent_2' : {'system_prompt': "Respond with a thought and then your response to the question {helper_response}", 'model_name': 'gemma2-9b-it'},
    'layer_agent_3' : {'model_name': 'llama3-8b-8192'},
    'layer_agent_4' : {'model_name': 'gemma2-9b-it'},
